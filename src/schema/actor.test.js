  ...
  describe("resolvers", () => {
    describe("directors", () => {
      ...
      it("should get all directors", () => {
        const directors = resolver({movies: moviesData.getMovies().map((movie) => movie.title)});
      ...
      it("should get all directors of movies the actor played in", () => {
        ...
        const directors = resolver(testActor);
      ...
      it("should return an empty array in case no movie matches", () => {
        const directors = resolver({movies: ["Test Movie 1234"]});
